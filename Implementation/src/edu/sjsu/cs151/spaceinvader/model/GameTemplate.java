...
/**
 * Implementation of TEMPLATE design pattern which involves an abstract class that exposes 
 * defined ways/templates to execute its methods. Subclasses can override the method 
 * implementation as per need but the invocation is to be in the same way as defined by the 
 * abstract class. Behavior pattern.
 */
